...
import {Box, Card, Flex, Text, Grid, Heading, useForwardedRef, CardTone} from '@sanity/ui'
...
import {ImageRatio} from '../common/ImageRatio'
...
function LoadStatus(props: {children: React.ReactNode; tone?: CardTone}) {
  return (
